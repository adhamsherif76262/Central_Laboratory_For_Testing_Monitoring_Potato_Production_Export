  ...
  return (
    ...
    >
      <div className="relative w-full h-full flex items-center justify-center">
        {/* EN */}
        <span
          className={`absolute text-3xl font-bold text-emerald-400 transition-all duration-700 ${
            activeLanguage === "ar"
        ...
        {/* AR */}
        <span
          className={`absolute text-3xl font-bold text-blue-400 transition-all duration-700 ${
            activeLanguage === "en"
              ? "opacity-100 scale-100 rotate-0"
              : "opacity-0 scale-50 -rotate-180"
          }`}
